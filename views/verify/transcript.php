...
$student = null;
$status = 'pending';
$message = 'Enter Student ID and verification code/hash to validate an official transcript.';
$generatedCode = '';
$generatedHash = '';
...
<div class="container py-5">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <p class="text-muted mb-4">Use Student ID plus verification code/hash from transcript export.</p>

            <form method="get" class="mb-4">
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>Student ID</label>
                        <input type="text" name="student_id" value="<?php echo e($providedStudentId); ?>" class="form-control" required>
                    </div>
                    <div class="form-group col-md-4">

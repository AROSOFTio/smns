    ...
    <div class="login-container">
        <div class="login-card finance-theme">
            ...
            <form method="POST" action="" class="login-form" autocomplete="on">
                ...
                <input type="hidden" name="username" value="<?php echo htmlspecialchars($entered_username); ?>" autocomplete="section-finance username">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text"
                                   ...
                                   autocomplete="section-finance username"
                                   required autofocus>
                ...
                <?php elseif ($step === 2): ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper" style="position:relative;">
                            <input type="password"
                                   ...
                                   autocomplete="section-finance current-password"
                                   required autofocus>
                    ...
                    <div class="text-center mt-2">
                        <a href="<?php echo e(BASE_URL . '/views/auth/forgot-password.php?role=finance'); ?>" class="btn btn-link btn-sm">
                            Forgot password?
                        </a>
                    </div>

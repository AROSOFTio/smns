...
// Check if finance user is already logged in
if (session_status() === PHP_SESSION_ACTIVE) {
    session_write_close();
}
session_name('SMNS_FINANCE_SESSION');
@session_start();

if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true && $_SESSION['role'] === 'finance') {
...
<head>
    ...
    <style>
        .login-card { border-top: 4px solid #ffc107; }
        .btn-primary { background-color: #ffc107; border-color: #ffc107; color: #212529; }
        .btn-primary:hover { background-color: #e0a800; border-color: #d39e00; color: #212529; }
    </style>
</head>
<body>
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <h2><?php echo APP_SHORT_NAME; ?> - Finance Portal</h2>
                <p>Finance Access Only</p>
            </div>
            ...
            <form method="POST" action="" class="login-form">
                ...
                <div class="form-group">
                    <label for="username">Finance Username</label>
                    <input type="text" 
                           class="form-control" 
                           id="username" 
                           name="username" 
                ...
                <button type="submit" class="btn btn-primary btn-block">
                    <i class="fas fa-sign-in-alt"></i> Finance Sign In
                </button>
